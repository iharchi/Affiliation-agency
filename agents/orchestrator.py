...
AGENT_TASKS = {
    ...
    "email_marketing": {
        ...
        # Kit API operations
        "kit_status": "Check Kit (ConvertKit) API connection status",
        "add_subscriber": "Add subscriber (context: email=<str>, first_name=<str>, tags=<csv>)",
        "list_subscribers": "List subscribers from Kit",
        "create_tag": "Create a tag (context: name=<str>)",
        "list_tags": "List all tags from Kit",
        "tag_subscriber": "Tag a subscriber (context: tag_id=<int>, subscriber_id=<int>)",
        "list_sequences": "List all sequences from Kit",
        "add_to_sequence": "Add subscriber to sequence (context: sequence_id=<int>, email=<str>)",
        "send_broadcast": "Send broadcast (context: subject=<str>, content=<str>, preview_text=<str>)",
        "list_broadcasts": "List broadcasts from Kit",
        "list_forms": "List forms from Kit",
        "add_to_form": "Add subscriber to form (context: form_id=<int>, email=<str>)",
    },
    "revenue_tracking": {
